# ~~CURSOR MERGE MAP~~ — DEPRECATED

> **이 문서는 폐기되었습니다.**
>
> `phonara-world-main`으로의 이식은 **영구 금지**입니다.
...
> - `docs/SUPABASE-PROJECT-LOCK.md`

아래 내용은 역사적 참고용이며 **실행하지 마세요**.

---

# (ARCHIVED) PHONARA V2 Visual Lab → phonara-world-main
