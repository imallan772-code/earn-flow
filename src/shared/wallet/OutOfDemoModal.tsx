    ...
    >
      ...
      >
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-2xl bg-gold py-3.5 text-sm font-extrabold text-(--color-bg-0) shadow-glow-gold transition active:scale-[0.98]"
        >
          <TrendingUp size={16} />
          리얼 모드로 전환하기
        </button>
