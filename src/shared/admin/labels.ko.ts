...
export const ADMIN_KO = {
  ...
  promo: {
    ...
    analytics: {
      ...
      legendDispatch: "발송",
      legendClick: "클릭",
      clicksScopeNote: "데모 · 발송·클릭은 로컬 집계",
    ...
    publish: {
      ...
      oauthConnect: "연결",
      oauthConnecting: "OAuth 창 여는 중…",
      oauthConnected: "연동됨",
      oauthDisconnected: "미연동",
      oauthStartFail: "OAuth 시작 실패",
      oauthCallbackOk: (ch: string) => `${ch} 연동 완료`,
      oauthCallbackFail: "OAuth 연동 실패",
      oauthErrorReasons: {
        invalid_channel: "지원하지 않는 채널입니다",
        missing_code: "OAuth 코드를 받지 못했습니다",
        state_mismatch: "보안 검증 실패 (state) — 다시 시도",
        app_not_configured: "OAuth 앱이 등록되지 않았습니다",
