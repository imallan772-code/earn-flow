...
export const CRASH_RULES: GameRules = {
  ...
  sections: [
    ...
    },
    {
      title: "배당 계산",
      body:
        "순수익 = 베팅액 × (캐쉬아웃 배수 × RTP − 1). 예: 10 USDT를 2.00x에서 캐쉬아웃 → +9.40 USDT (RTP 97%).",
    },
    {
      title: "데모 vs 리얼",
      body:
        "• 데모: 1회 체험 크레딧 ₩10,000 지급, 추가 리필 없음. RTP 97% (리얼과 동일).\n• 리얼: 실제 입금/출금. RTP 97% (3% 하우스 엣지).",
    },
    {
  ...
  sections: [
    {
      title: "기본 규칙",
      body:
        "0.00 ~ 99.99 사이의 숫자가 무작위로 굴려집니다. 베팅 버튼을 누르는 즉시 결과가 나옵니다(대기 타이머 없음). 목표값(target)보다 높게(OVER) 나오는 데 베팅할지, 낮게(UNDER) 나오는 데 베팅할지 선택하세요.",
    },
    {
      title: "승리 조건",
      body:
    ...
    },
    {
      title: "배당 계산",
      body:
        "배당 = (99 × RTP) / 승리 확률(%). 승률이 낮을수록 배당이 높습니다. 예: 50% 승률 → 1.92x (RTP 97%).",
    },
    {
      title: "데모 vs 리얼",
      body:
        "• 데모: 1회 체험 크레딧 ₩10,000, 추가 리필 없음. RTP 97% (리얼과 동일).\n• 리얼: 실제 입금/출금. RTP 97% (3% 하우스 엣지).",
    },
    {
      title: "공정성 (Provably Fair)",
      body:
...
export const PLINKO_RULES: GameRules = {
  ...
  sections: [
    ...
    },
    {
      title: "배당 계산",
      body:
        "수익 = 베팅액 × 슬롯 배율 − 베팅액. 예: 10 USDT × 5.0x → 순수익 +40 USDT. 모든 모드에 RTP 97%가 적용됩니다.",
    },
    {
      title: "데모 vs 리얼",
      body:
