...
import { MOCK_LANDING_HERO_STATS } from "@/mocks/fomo";
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-md flex-col gap-5 px-5 pb-10 pt-6 safe-top">
        ...
        <section className="mt-2">
          ...
          <p className="mt-3 text-sm leading-relaxed text-[var(--color-muted)]">
            한국 <span className="font-semibold text-[var(--color-foreground)]">1,012만+ 명</span>이 매일 출석·미션·게임으로 PHON을 모아 KRW/USDT로 인출합니다. 가입 즉시 <span className="font-semibold text-[var(--color-gold)]">1,800 PHON</span>.
          </p>
        </section>
