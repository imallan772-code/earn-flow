      ...
      <main className="flex-1 px-4 pb-6 pt-3">
        ...
        <Premium3DCard className="p-5">
          <div className="grid grid-cols-3 gap-2 text-xs">
            <div className="text-[var(--color-muted)]">은행</div><div className="col-span-2 font-semibold">국민은행</div>
            <div className="text-[var(--color-muted)]">계좌</div><div className="col-span-2 font-numeric font-semibold">123-4567-8901-23</div>
            <div className="text-[var(--color-muted)]">예금주</div><div className="col-span-2 font-semibold">(주)포나라월드</div>
            <div className="text-[var(--color-muted)]">입금자명</div><div className="col-span-2 font-semibold">PHO-K7Q2X9 (회원코드)</div>
          </div>
